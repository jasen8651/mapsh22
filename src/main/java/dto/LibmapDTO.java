...
public class LibmapDTO {
	/*
	 * private String mart;//상호명 private String area;//한식중식일식 private String
	 * middlecategory;// 중분류 private String subdivision; // 소분류 private String
	 * dong;//동 private String address; private String latitude; private String
	 * longitude;
	 */
	 ...
	 * 
	 * 
	 * public String getArea() { return area; //키워드 }
	 * 
	 * public void setArea(String area) { this.area = area; //키워드 }
	 * 
	 ...
	 * 
	 * public void setMiddlecategory(String middlecategory) { this.middlecategory =
	 * middlecategory; }
	 * 
